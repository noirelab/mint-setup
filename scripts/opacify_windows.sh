...
EXCLUDE_OPACITY=93           # Excluded windows
FULLSCREEN_OPACITY=100        # Full screen windows
TILED_OPACITY=93             # Tiled focused windows
MAXIMISED_OPACITY=93         # Maximised focused windows
DEMANDS_ATTENTION_OPACITY=100 # Any window demanding attention
FOCUS_OPACITY=93              # Focused non-maximised application
GROUP_OPACITY=93              # Unfocussed applications that share a PID with the focussed application
DEFAULT_OPACITY=93            # Any others - e.g unfocused applications.
